...
implements IntentService
{
	...
	@Override
	public GoogleCloudDialogflowV2Intent execute(EntityItem<GoogleCloudDialogflowV2Intent> requestEnity){
		GoogleCloudDialogflowV2Intent responseEntity = new GoogleCloudDialogflowV2Intent();
		return execute(requestEnity, responseEntity);		
	}
	
	@Override
	public GoogleCloudDialogflowV2Intent List(EntityItem<GoogleCloudDialogflowV2Intent> requestGet) {
	...
	@Override
	public GoogleCloudDialogflowV2Intent Create(EntityItem<GoogleCloudDialogflowV2Intent> requestPost) {
		requestPost.setUriTemplate("v2/projects/" + this.getProjectId() + "/agent/intents");		
		return super.Create(requestPost);
	}
	
	@Override
	public GoogleCloudDialogflowV2Intent Get(EntityItem<GoogleCloudDialogflowV2Intent> requestGet) {
	...
	@Override
	public GoogleCloudDialogflowV2Intent Update(EntityItem<GoogleCloudDialogflowV2Intent> requestPut) {
		requestPut.setUriTemplate("v2/projects/" + this.getProjectId() + "/agent/intents/" + requestPut.getId());
		return super.Update(requestPut);
	}
	
	@Override
	public GoogleCloudDialogflowV2Intent Delete(EntityItem<GoogleCloudDialogflowV2Intent> requestDelete) {
